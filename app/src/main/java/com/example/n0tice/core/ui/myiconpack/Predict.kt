package com.example.n0tice.core.ui.myiconpack
...
public val MyIconPack.Predict: ImageVector
    get() {
        if (_predict != null) {
            return _predict!!
        }
        _predict = Builder(name = "Predict", defaultWidth = 512.0.dp, defaultHeight =
...
private var _predict: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MyIconPack.Predict, contentDescription = "")
    }
}
